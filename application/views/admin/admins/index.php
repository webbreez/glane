...
$(document).ready(function(){
	...
	$("#add").live('click', (function () {
		location.href='<?php echo url::site()?>admin/admins/add/';
	}));

	$(".edit").live('click', (function () {
		var id = $(this).attr('id');
		location.href='<?php echo url::site()?>admin/admins/edit/'+id;
	}));
    ...
    if (confirm("Are you sure you want to delete this?")){
		  ...
		  $.post("<?php echo url::site()?>admin/admins/delete", {id: id}, function(data){
			  $("tr#row_"+id).remove();
	...
	oTable = $('#datatables').dataTable( {
		...
		"bProcessing": true,
		"bServerSide": true,
		"sAjaxSource": "<?php echo url::site()?>admin/datatables/list_data/admins/",
		"aaSorting": [[ 1, "desc" ]]
...
<h3>ADMINS</h3>
<br />
<div style="float: left;"><input type="button" value="Add New Admin" id="add"></div>
<br />
<br />
<table align="center" cellpadding="0" cellspacing="0" border="0" width="100%" class="table table-striped table-bordered" id="datatables">
	<thead>
		<tr>
			<th width="40%" id="firstname">First Name</th>
			<th width="40%" id="lastname">Last Name</th>
			<th width="20%">&nbsp;</th>
		</tr>
	</thead>
	<tbody>

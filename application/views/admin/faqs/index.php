...
$(document).ready(function(){
	...
	$("#add").live('click', (function () {
		location.href='<?php echo url::site()?>admin/faqs/add';
	}));

	$(".edit").live('click', (function () {
		var id = $(this).attr('id');
		location.href='<?php echo url::site()?>admin/faqs/edit/'+id;
	}));
    ...
    if (confirm("Are you sure you want to delete this?")){
		  ...
		  $.post("<?php echo url::site()?>admin/faqs/delete", {id: id}, function(data){
			  $("tr#row_"+id).remove();
	...
	oTable = $('#datatables').dataTable( {
		...
		"bProcessing": true,
		"bServerSide": true,
		"sAjaxSource": "<?php echo url::site()?>admin/datatables/list_data/faqs",
		"aaSorting": [[ 1, "desc" ]]

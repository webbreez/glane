...
$(document).ready(function(){
	...
	$(".download").live('click', (function () {
		var id = $(this).attr('id');
		location.href='<?php echo url::site()?>admin/legal_documents/download/'+id;
	}));

	$(".approve").live('click', (function () {
		var id = $(this).attr('id');
		location.href='<?php echo url::site()?>admin/legal_documents/approve/'+id+"/"+<?php echo $member->user_id?>;
	}));

	$(".decline").live('click', (function () {
		var id = $(this).attr('id');
		location.href='<?php echo url::site()?>admin/legal_documents/decline/'+id+"/"+<?php echo $member->user_id?>;
	}));
	...
	oTable = $('#datatables').dataTable( {
		...
		"bProcessing": true,
		"bServerSide": true,
		"sAjaxSource": "<?php echo url::site()?>admin/datatables/list_data/legal_documents/<?php echo $member->user_id?>",
		"aaSorting": [[ 1, "desc" ]]

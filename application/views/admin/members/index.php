...
$(document).ready(function(){
	...
	$("#add").live('click', (function () {
		location.href='<?php echo url::site()?>admin/members/add/';
	}));
	...
	$(".products").live('click', (function () {
		var id = $(this).attr('id');
		location.href='<?php echo url::site()?>admin/products/view/'+id;
	}));

	$(".edit").live('click', (function () {
		var id = $(this).attr('id');
		location.href='<?php echo url::site()?>admin/members/edit/'+id;
	}));
	...
	oTable = $('#datatables').dataTable( {
		...
		"bProcessing": true,
		"bServerSide": true,
		"sAjaxSource": "<?php echo url::site()?>admin/datatables/list_data/users/",
		"aaSorting": [[ 1, "desc" ]]
...
<h3>MEMBERS</h3>
<br />
<div style="float: left;"><input type="button" value="Add New Member" id="add"></div>
<br />
<br />
<table align="center" cellpadding="0" cellspacing="0" border="0" width="100%" class="table table-striped table-bordered" id="datatables">
	<thead>
		<tr>
			...
			<th width="25%" id="user_status">Status</th>
			<th width="25%">&nbsp;</th>
		</tr>
	</thead>
	<tbody>

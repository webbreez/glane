...
?>
<tr>
	<td colspan="4" align="right"><button id="checkout">Checkout</button>&nbsp;<button id="continue_shopping">Continue Shopping</button></td>
</tr>
</table>
	...
	$(".qty").blur(function(){
		...
		$.ajax({
	        ...
	        success: function(data) {
	        	...
	        	{
	        		alert(data.error_msg);
	        		location.href="<?php echo URL::site('cart/index');?>/";
	        		return false;
	        	}

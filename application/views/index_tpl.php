...
<div class="mainmenu mmdesktop">
    <ul>
        ...
        <li><a href="" class="catmenu">Categories <span class="sp">+</span><span class="sm sppt">-</span></a></li>
    </ul>
</div><!-- main menu -->
<?php
/*
...
if($this->uri->segment(1) == "index" || $this->uri->segment(1) == "")
{
    ...
    <!-- <ul class="featuredrelated"> -->
        <?php
        /*
        $related_products = relatedproducts_helper::get_related_products($fp->product_id);
        foreach($related_products as $rp)
        {
            if(productpicture_helper::get_product_picture($rp->product_id))
            {
            ?>
            <li><a href="<?php echo URL::site('product_listing/details');?>/<?php echo $rp->product_id?>" style="background-image: url(<?php echo url::base();?>timthumb.php?src=<?php echo url::base();?>assets/upload/<?php echo productpicture_helper::get_product_picture($rp->product_id)?>&w=147&h=90&zc=2);">see details &raquo;</a></li>
            <?php
            }else{
            ?>
            <li><a href="<?php echo URL::site('product_listing/details');?>/<?php echo $rp->product_id?>" style="background-image: url(<?php echo url::base();?>timthumb.php?src=<?php echo url::base();?>assets/images/no_image.jpg&w=147&h=90&zc=2);">see details &raquo;</a></li>
            <?
            }
        }
        */
...
<!-- main list product --><ul class="mainlistproduct">

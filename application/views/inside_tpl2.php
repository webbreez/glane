...
<div class="headerlinks2">
    <ul>
        <li><a href="<?php echo URL::site('login');?>">Sign in</a></li>
...
Copyright &copy; <?php echo date('Y'); ?> LogicLane LLC. &nbsp;&nbsp; All Rights Reserved. &nbsp;&nbsp;   <a href="<?php echo URL::site('page/view/10/user-agreement');?>">User Agreement</a>  |   <a href="<?php echo URL::site('page/view/11/privacy-policy');?>">Privacy Policy</a>  |  <a href="<?php echo URL::site('page/view/12/sales-donations-policy');?>">Sales & Donations Policy</a>

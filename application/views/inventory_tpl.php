                ...
                <div class="span2 sidebar-width">
                    <div class="well sidebar-nav-fixed">
                        <ul class="nav nav-list">
                            <li <?echo $this->uri->segment(1) == "home" ? "class='active'": '' ?> ><a href="<?php echo URL::site('inventory/home');?>">Home</a></li>
                            <li <?echo $this->uri->segment(1) == "settings" ? "class='active'": '' ?> ><a href="<?php echo URL::site('inventory/settings');?>">Settings</a></li>
                            <li <?echo $this->uri->segment(1) == "members" ? "class='active'": '' ?> ><a href="<?php echo URL::site('inventory/purchases');?>">Purchases</a></li>
                        <ul>
                    </div> <!-- /sidebar -->
                </div> <!-- /span -->

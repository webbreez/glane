...
<li class="bgo0">
<div class="col1">
	<a href="<?php echo URL::site('items/details');?>/<?php echo $product->product_id?>">
	<?php
	if($this->get_product_picture($product->product_id))
	{
	?>
	<img src="<?php echo url::base();?>timthumb.php?src=<?php echo url::base();?>assets/upload/<?php echo $this->get_product_picture($product->product_id)?>&w=149&h=92&zc=2&zc=2" border="0" />
	<?php
	}else{
	?>
...
&nbsp;
<a href="<?php echo URL::site('items/details');?>/<?php echo $product->product_id?>">View Product</a>
</div>

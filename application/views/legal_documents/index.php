...
$(document).ready(function(){
	...
	$("#upload_legal_document").live('click', (function () {
		location.href='<?php echo url::site()?>legal_documents/add/';
	}));

	$(".download").live('click', (function () {
		var id = $(this).attr('id');
		location.href='<?php echo url::site()?>legal_documents/download/'+id;
	}));
    ...
    if (confirm("Are you sure you want to delete this?")){
		  ...
		  $.post("<?php echo url::site()?>legal_documents/delete", {id: id}, function(data){
			  $("tr#row_"+id).remove();
	...
	oTable = $('#datatables').dataTable( {
		...
		"bProcessing": true,
		"bServerSide": true,
		"sAjaxSource": "<?php echo url::site()?>datatables/list_data/legal_documents/",
		"aaSorting": [[ 1, "desc" ]]
...
<h1 class="spacedhead">Documents</h1>
<br />
<div style="float: left;"><input type="button" value="Upload Legal Document" id="upload_legal_document"></div>
<br />
<br />
<table align="center" cellpadding="0" cellspacing="0" border="0" width="100%" class="table table-striped table-bordered" id="datatables">
	<thead>
		<tr>
			<th width="25%" id="document_name">Title</th>
			<th width="25%" id="last_modified_date">Date Uploaded</th>
			<th width="25%" id="user_name">Status</th>
			<th width="25%">&nbsp;</th>
		</tr>
	</thead>
	<tbody>

...
$(document).ready(function(){
	...
	$(".view").live('click', (function () {
		var id = $(this).attr('id');
		location.href='<?php echo url::site()?>my_orders/view/'+id;
	}));
	...
	oTable = $('#datatables').dataTable( {
		...
		"bProcessing": true,
		"bServerSide": true,
		"sAjaxSource": "<?php echo url::site()?>datatables/list_data/my_orders/",
		"aaSorting": [[ 1, "desc" ]]
...
<table align="center" cellpadding="0" cellspacing="0" border="0" width="100%" class="table table-striped table-bordered" id="datatables">
	<thead>
		<tr>
			<th width="25%" id="uniq_id">Order ID</th>
			<th width="25%" id="status">Status</th>
			<th width="25%" id="date_added">Date Ordered</th>
			<th width="25%">&nbsp;</th>
		</tr>
	</thead>
	<tbody>

...
<?php echo form::open_multipart("register/step_3/$uid", array('id'=>'register_form', 'class'=>'form-horizontal'));?>

<ul class="mainbodyform" style="width:400px;float:left;">
	<li>
		<strong>Internal Revenue Service W-9 Form</strong><br />
		Download the form <a href="http://www.irs.gov/pub/irs-pdf/fw9.pdf">here</a><br />
	...
	<li>
		<strong>State of Incorporation OR State of Organization</strong><br />
		...
		<!-- <input type="file" name="state_of_incorporation[]" id="state_of_incorporation" class="span3 required" />
		<div id="div_upload_more_state_of_incorporation"></div>
		<div>
			<a href="javascript:void(0)" id="upload_more_state_of_incorporation">Upload More</a>
		</div> -->
	</li>
	<?php
	/*
	...
	*/?>
	...
	<li>
		<!-- Documentation Regarding Charitable Status<br /> (Note: Optional, unless charity)<br /> -->
		<strong>Upload 501(c)(3) charity documentation from IRS</strong>
		<input type="file" name="documentation_regarding_charitable_status[]" id="documentation_regarding_charitable_status" class="span3 required" />
		<div id="div_upload_more_documentation_regarding_charitable_status"></div>
		<div>
			<a href="javascript:void(0)" id="upload_more_documentation_regarding_charitable_status">Upload More</a>
